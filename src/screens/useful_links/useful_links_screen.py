...
screen_options = [
  screenNames.GENERAL_SCREEN, screenNames.BROWSE_INCOLLEGE_SCREEN,
  screenNames.BUSSINESS_SOLUTIONS_SCREEN, screenNames.DIRECTORIES_SCREEN
]


def screen():
  screen_display = "Welcome to useful links screen!"
